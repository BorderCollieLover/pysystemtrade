...
Instrument_to_IB_Futures_Contract_Ticker_Mapping = [
    ...
    #{'instrument': 'MILKDRY', 'contract_ticker_format': 'GNF[FGHJKMNQUVXZ][0-9]_*', 'year_length': 1, 'month_length': 1},
    ...
    #{'instrument': 'USDCNH-CME', 'contract_ticker_format': 'CNH[FGHJKMNQUVXZ][0-9]_*', 'year_length': 1, 'month_length': 1},
    {'instrument': 'CNH-HK', 'contract_ticker_format': 'CUS[FGHJKMNQUVXZ][0-9]_*', 'year_length': 1, 'month_length': 1},
